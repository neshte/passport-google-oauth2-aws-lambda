...
var util = require('util')
  , OAuth2Strategy = require('passport-oauth2-aws-lambda')
  , InternalOAuthError = require('passport-oauth2-aws-lambda').InternalOAuthError;
...
Strategy.prototype.authenticate = function(req, options) {
  ...
  options.loginHint = req.queryStringParameters ? req.queryStringParameters.login_hint : null
